...
Run the following command and provide the latest stable version (e.g v13.0.\*) :
...
#### For Laravel 13.0
```json
"laravelium/feed": "13.0.*"
```
(development branch)
```json
"laravelium/feed": "13.0.x-dev"
```

#### For Laravel 12.0
```json
"laravelium/feed": "12.0.*"
```
(development branch)
```json
"laravelium/feed": "12.0.x-dev"
```

#### For Laravel 11.0
```json
"laravelium/feed": "11.0.*"
```
(development branch)
```json
"laravelium/feed": "11.0.x-dev"
```

#### For Laravel 10.0
```json
"laravelium/feed": "10.0.*"
```
(development branch)
```json
"laravelium/feed": "10.0.x-dev"
```
